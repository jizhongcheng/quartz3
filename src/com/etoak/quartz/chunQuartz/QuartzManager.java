...
public class QuartzManager {
   ...
   public static void addJob(String jobName,Job job,String time) throws SchedulerException, ParseException{
       ...
       System.out.println(sched.getJobDetail(jobName, JOB_GROUP_NAME)+"<<<<<<<<<<<<<<<<<<<<<<<");//null  or JobDetail
       System.out.println(sched.getTriggerState(jobName, TRIGGER_GROUP_NAME)+"****************");// -1 or 0
